...
const Request = () => {
  ...
  //useEffect call
  useEffect(() => {
    Axios.get("https://dpen7fi5y2.execute-api.us-east-1.amazonaws.com/developement/home").then((response) => {
  ...
  const requestBlood = () => {
    // Axios.post("https://dpen7fi5y2.execute-api.us-east-1.amazonaws.com/developement/request", {
