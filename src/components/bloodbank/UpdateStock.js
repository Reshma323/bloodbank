...
const UpdateStock = () => {
  ...
  //useEffect call
  useEffect(() => {
    Axios.get("https://dpen7fi5y2.execute-api.us-east-1.amazonaws.com/developement/login/emp/ub", (req, res) => {}).then(
      (response) => {
  ...
  //updateBloodStock
  const ubStock = (b_id) => {
    Axios.put("https://dpen7fi5y2.execute-api.us-east-1.amazonaws.com/developement/login/emp/ub/update", {
      b_id: b_id,
